...
def ask_path(
    ...
    while True:
        ...
        # Option A: Select Current Directory
        # Using a distinct icon to separate actions from folders
        choices.append(Choice(value=".", name=f"✅ SELECT CURRENT: {current_path.name}/"))
        
        # Option B: Go Up (if not root)
...
def ask_select(
    ...
    """
    Select one or multiple options. Returns None if Ctrl+C is pressed.
    """
