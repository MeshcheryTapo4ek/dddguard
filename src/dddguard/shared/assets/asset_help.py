...
def get_linter_help_renderable():
    ...
    # 1. Header
    grid.add_row(Text("🚀 Validates Architecture Rules on the main project.", style="bold cyan"))
    grid.add_row(Text("The Linter enforces strict DDD constraints based on the Laws of Clean Architecture.", style="italic dim"))
    grid.add_row("")
    ...
    grid.add_row(Panel(table, title="🧱 LAYER ISOLATION RULES", border_style="blue", box=ROUNDED))
    grid.add_row("")
